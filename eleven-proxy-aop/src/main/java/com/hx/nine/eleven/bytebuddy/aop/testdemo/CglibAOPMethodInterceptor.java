...
public class CglibAOPMethodInterceptor implements MethodInterceptor {

    @Override
    public Object intercept(Invocation invocation) throws Throwable {
        Object result = null;
        Method method = invocation.getMethod();
        MethodProxy methodProxy = invocation.getMethodProxy();
        Object target = invocation.getTarget();
        Object[] arguments = invocation.getArguments();
        String da = method != null? findKey(method,target,arguments):"nullllll";
        try {
