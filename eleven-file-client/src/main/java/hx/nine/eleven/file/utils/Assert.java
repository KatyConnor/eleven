...
public abstract class Assert {
    ...
    public static void doesNotContain( String textToSearch, String substring, String message) {
        if (isHasLength(textToSearch) && isHasLength(substring) && textToSearch.contains(substring)) {
            throw new IllegalArgumentException(message);
        }
    }
    ...
    public static boolean objIsEmpty(Object[] array) {
    ...
    public static boolean isHasText(String str) {
