...
public abstract class AbstractRunMojo extends AbstractDependencyFilterMojo {
	 ...
	 * consider adding {@code eleven-devtools} to your project instead as it provides
	 * this feature and many more.
	 * @since 1.0.0
	 */
	@Parameter(property = "eleven.run.addResources", defaultValue = "false")
	 ...
	 * @since 2.2.0
	 */
	@Parameter(property = "eleven.run.agents")
	private File[] agents;
	 ...
	 * @since 1.0.0
	 */
	@Parameter(property = "eleven.run.noverify")
	 ...
	 * @since 1.5.0
	 */
	@Parameter(property = "eleven.run.workingDirectory")
	 ...
	 * @since 1.1.0
	 */
	@Parameter(property = "eleven.run.jvmArguments")
	 ...
	 * @since 2.2.3
	 */
	@Parameter(property = "eleven.run.arguments")
	 ...
	 * @since 1.3.0
	 */
	@Parameter(property = "eleven.run.profiles")
	 ...
	 * @since 1.0.0
	 */
	@Parameter(property = "eleven.run.main-class")
	 ...
	 * @since 1.0.0
	 */
	@Parameter(property = "eleven.run.directories")
	 ...
	 */
	@Parameter(property = "eleven.run.fork", defaultValue = "true")
	@Deprecated
	 ...
	 * @since 1.3.0
	 */
	@Parameter(property = "eleven.run.useTestClasspath", defaultValue = "false")
	 ...
	 * @since 1.3.2
	 */
	@Parameter(property = "eleven.run.skip", defaultValue = "false")
