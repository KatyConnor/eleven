...
public class BuildImageMojo extends AbstractPackagerMojo {
	 ...
	 * @since 2.3.0
	 */
	@Parameter(property = "eleven.build-image.skip", defaultValue = "false")
	 ...
	 * @since 2.3.0
	 */
	@Parameter(property = "eleven.build-image.imageName", readonly = true)
	String imageName;
	 ...
	 * @since 2.3.0
	 */
	@Parameter(property = "eleven.build-image.builder", readonly = true)
	String imageBuilder;
	 ...
	 * @since 2.3.1
	 */
	@Parameter(property = "eleven.build-image.runImage", readonly = true)
	String runImage;
	 ...
	 * @since 2.4.0
	 */
	@Parameter(property = "eleven.build-image.cleanCache", readonly = true)
	Boolean cleanCache;
	 ...
	 * property.
	 */
	@Parameter(property = "eleven.build-image.pullPolicy", readonly = true)
	PullPolicy pullPolicy;

	/**
	 * Alias for {@link Image#publish} to support configuration via command-line property.
	 */
	@Parameter(property = "eleven.build-image.publish", readonly = true)
	Boolean publish;
	 ...
	 * @since 2.6.0
	 */
	@Parameter(property = "eleven.build-image.network", readonly = true)
	String network;
