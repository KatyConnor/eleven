 ...
 */
package com.hx.nine.eleven.datasources.properties.druid;

import com.alibaba.druid.wall.WallConfig;
import com.hx.nine.eleven.datasources.utils.DsConfigUtil;
...
public final class DruidWallConfigUtil {
     ...
     * @return 防火墙配置
     */
    public static WallConfig toWallConfig(Map<String, Object> wallMap) {
        WallConfig wallConfig = new WallConfig();
        Object dir = wallMap.get("dir");
        if (dir != null) {
            wallConfig.loadConfig(String.valueOf(dir));
        }
        for (Map.Entry<String, Object> item : wallMap.entrySet()) {
