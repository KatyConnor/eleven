...
<generatorConfiguration>
    <context id="para"
             targetRuntime="com.hx.nine.eleven.mybatis.flex.tools.mybatis.generator.impl.CIMSIntrospectedTableMyBatis3SimpleImpl">
        <property name="javaFileEncoding" value="UTF-8"/>
        <commentGenerator
                type="com.hx.nine.eleven.mybatis.flex.tools.mybatis.generator.generators.CIMSCommentGenerator"/>
        <jdbcConnection driverClass="oracle.jdbc.driver.OracleDriver"
                        connectionURL="jdbc:oracle:thin:@10.9.166.38:1521:devutf12c"
                        userId="cims_wholeflow" password="Cqrcb256">
            <property name="remarksReporting" value="true"/>
        </jdbcConnection>
        <javaTypeResolver type="com.hx.nine.eleven.mybatis.flex.tools.mybatis.generator.types.CIMSJavaTypeResolver"/>
        <javaModelGenerator targetPackage="com.cqrcb.cims.common.db.entity" targetProject="src/main/java">
            <property name="constructorBased" value="true"/>
            <property name="rootClass" value="com.hx.nine.eleven.mybatis.flex.common.db.entity.BaseControlledEntity"/>
        </javaModelGenerator>
        <sqlMapGenerator targetPackage="com.cqrcb.cims.common.db.mapper"
                         targetProject="src/main/java"/>
        <table tableName="DATA_PERMISSION" schema="CIMS_WHOLEFLOW">
