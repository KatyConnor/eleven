package com.hx.domain.framework.syscode;
...
public interface DomainApplicationSysCode extends ApplicationSysMessageCode {
    ...
    MessageCode A0100000001 = new MessageCode(MessageCodeType.APPLICAION,"A0100000001", "[domain]领域对象[{}]必须继承[com.hx.domain.framework.obj.ddo.DomainDO]");
    MessageCode A030000000 = new MessageCode(MessageCodeType.APPLICAION,"A030000000", "数据库数据查询返回[com.hx.domain.framework.entity.DataMapperEntity<P extends BasePO>]不能null");
