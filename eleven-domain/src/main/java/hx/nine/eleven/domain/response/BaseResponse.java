...
public class BaseResponse<R> implements Serializable {
    ...
    public BaseResponse successful(){
        ...
        this.code = ApplicationSystemCode.B0000000000.getCode();
        this.message = ApplicationSystemCode.B0000000000.getMessage();
        return this;
    }

    public BaseResponse failure(){
        this.statusCode = SystemCode.FAILED.getCode();
        this.code = ApplicationSystemCode.B0000000001.getCode();
        this.message = ApplicationSystemCode.B0000000001.getMessage();
        return this;
    }
}
