...
import hx.nine.eleven.domain.context.thread.DomainContextThreadPoolEvent;
...
import hx.nine.eleven.domain.web.WebServletRoutor;
import hx.nine.eleven.sync.fiber.FiberCheck;
...
public class DomainContextAware {
	...
	/**
	 * 获取上下文
	 * 1、http请求进入的，在路由入口{@sine hx.nine.eleven.domain.web.WebServletRoutor.doService}生成上下文
