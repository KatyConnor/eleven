...
import com.hx.nine.eleven.thread.pool.executor.factory.AbstractThreadFactory;
...
public class ThreadPoolManageExecutor{
   ...
   public FiberPoolExecutor getFiberPoolExecutor(String threadGroupName){
       ...
       return fiberPoolExecutor;
//       throw new ThreadExecuteException(com.hx.nine.eleven.commons.utils.StringUtils.format("没有查找到线程池[{}]对应的协程执行器",groupName));
    }
