package com.hx.vertx.boot.properties;
...
import com.hx.vertx.boot.convert.FieldIntegerToLongConvert;
import com.hx.vertx.boot.convert.FieldStringToArraysDeserializer;
 ...
 * @Date 2023-03-19
 */
@ConfigurationPropertiesBind(prefix = "vertx.hx.boot")
