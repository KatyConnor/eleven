 ...
 * @date 2024/9/26
 */
public class ElevenDataSourceSubLoadFactory implements ApplicationSubTypesInitFactory {
	...
	public void loadSubTypesObject(Reflections reflections) throws Throwable {
		...
		if (mapperSet == null || mapperSet.size() > 1){
			ElevenLoggerFactory.build(ElevenDataSource.class).warn(mapperSet == null?
